...
public class SoalKurang1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_kurang1);
        ...
        pilihan1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                totalNilai = 0;
                Intent intent = new Intent(SoalKurang1.this, SoalKurang2.class);
