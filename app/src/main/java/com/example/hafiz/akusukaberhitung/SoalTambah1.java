...
import static com.example.hafiz.akusukaberhitung.R.drawable.soal;

public class SoalTambah1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_tambah1);
        ...
        pilihan1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                totalNilai=0;
                Intent intent=new Intent(SoalTambah1.this, SoalTambah2.class);
