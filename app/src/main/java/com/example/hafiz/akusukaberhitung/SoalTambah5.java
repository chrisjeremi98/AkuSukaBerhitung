...
import static com.example.hafiz.akusukaberhitung.R.id.nilai;
import static com.example.hafiz.akusukaberhitung.R.id.total_nilai;

public class SoalTambah5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_tambah5);
        ...
        pilihan1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(SoalTambah5.this, TotalSkorActivity.class);
